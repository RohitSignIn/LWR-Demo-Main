...
export default class Home extends Element {
    ...
    fetchFields() {
        ...
        const uid = queryParams.get('ceif');

        // const randomId = '670fa3db43d3fc822744d210'; // Replace with the actual ID you want to use
        const apiUrl = `http://13.202.250.26:3000/api/v1/template/${uid}`;
    ...
    handleFormSubmit() {
        try {
            ...
            axios.post("http://13.202.250.26:3000/api/v1/form_submit/", {"jsonData": userInputJson}).then(result => {
